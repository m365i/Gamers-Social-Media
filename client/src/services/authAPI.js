...
export function signup(name, email, password, birthdate,country) {
	return axios.post('/auth/signup', { name, email, password: sha256(password).toString(), birthdate ,country})
}
